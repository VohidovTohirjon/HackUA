...
export default function NavigationTabs({ tabs, activeTab, onChange, demoMode }) {
  return (
            ...
            <button
              ...
              className={`focus-ring flex min-h-12 items-center justify-center gap-2 rounded-md px-4 py-3 text-sm font-black transition active:scale-[0.99] ${
                active
                  ...
                  : `text-slate-600 hover:bg-slate-50 hover:text-ua-navy hover:ring-1 hover:ring-slate-200 ${demoMode ? 'ring-1 ring-red-100' : ''}`
              }`}
            >
